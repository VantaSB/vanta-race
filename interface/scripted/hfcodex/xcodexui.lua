...
local CODEX_BUTTON_STOCK = "/interface/scripted/hfcodex/codexbutton.png"
local CODEX_BUTTON_HOVER = "/interface/scripted/hfcodex/codexbuttonhover.png"

local RACE_BUTTON_STOCK = "/interface/scripted/hfcodex/racebutton.png"
local RACE_BUTTON_HOVER =  "/interface/scripted/hfcodex/racebuttonhover.png"

-- local NO_RACE_ICON = "/interface/scripted/hfcodex/icon_none.png"
-- local NO_RACE_ICON_HOVER = "/interface/scripted/hfcodex/icon_none_hover.png"
...
require("/scripts/ex_utilities/hfcodex/InitializationUtility.lua")

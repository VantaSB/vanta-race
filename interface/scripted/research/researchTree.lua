...
function searchButton()
	...
	if widget.active("searchList") then
		...
		{	base = "/interface/scripted/research/buttons.png:search:default",
			hover = "/interface/scripted/research/buttons.png:search:hover"	})
	elseif researchTree then
		...
		widget.setButtonImages("searchButton",
		{	base = "/interface/scripted/research/buttons.png:search:hover",
			hover = "/interface/scripted/research/buttons.png:search:default"	})
	end
end
...
function treePickButton()
	...
	if widget.active("treeList") then
		...
		{	base = "/interface/scripted/research/buttons.png:treePick:default",
			hover = "/interface/scripted/research/buttons.png:treePick:hover"	})
	else
		...
		widget.setButtonImages("treePickButton",
		{	base = "/interface/scripted/research/buttons.png:treePick:hover",
			hover = "/interface/scripted/research/buttons.png:treePick:default"	})
	end
end
		...
		for research, tbl in pairs(researchTree) do
			...
			if whithinBounds(startPoint, endPoint) then
				if tbl.state ~= "hidden" then
					...
					if research == selected then
						canvas:drawImage("/interface/scripted/research/iconBackground.png:selected", {startPoint[1]-2, startPoint[2]-2}, 1, color, false)
					else
						canvas:drawImage("/interface/scripted/research/iconBackground.png:default", {startPoint[1]-2, startPoint[2]-2}, 1, color, false)
					end
...
cheats = {
	...
	forgottenmemories = function()
		...
		pane.dismiss()
		player.interact("ScriptPane", "/interface/scripted/research/researchTree.config")
	end,
